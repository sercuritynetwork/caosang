...
quannumber=pink+'['+blue+' Nguyễn Cao Sang '+pink+']'
quannumber=pinkx+'[  Nguyễn Cao Sang ]'+end
quannumber=pink+"["+blue+" Nguyễn Cao Sang "+pink+"]"
quannumber=pink+"["+blue+" Nguyễn Cao Sang "+pink+"]"
def logo():
    log="""        
\033[1;31m ----------------------------------------------------------
\033[1;33m Nguyễn Cao Sang
\033[1;33mChào mừng bạn đến Tool
\033[1;31mFB: https://www.facebook.com/profile.php?id=100093624715780
\033[1;31m-------------------------------------------------
"""
    os.system('clear')  
    for h in log:
...
logo()
while(True):
        token_tds=input(pink+'\033[1;32mNhập Token TDS: \033[1;33m')
        print("\033[1;31m────────────────────────────────────────────────────────────")
...
while(True):
        while(True):
                while(True):
                        ck_fb=input(blue+'\033[1;32mNHẬP COOKIE FACEBOOK: \033[1;33m')
                        os.system("clear")
                        if ck_fb=='':break
                        ...
                        try:
                                ...
                                print(nguyencaosang,pink+'['+red+'Cookie fb die'+pink+']')
                if ck_fb=='':
                        print(blue+'THANKS BẠN ĐÃ SỬ DỤNG TOOL CỦA',nguyencaosang+' !')
                        quit()
                logo()
                ...
                if 'success' in run.text:
                        print(nguyencaosang,'['+run.json()['data']['msg'].upper()+']')
                        sleep(0.5)
                        break
                else:
                ...
                for x in range(0,len(list_nv.json())):
                        try:
                                ...
                                if 'success' in nhan_tien.text:
                                        ...
                                        print(quannumber+pink+'['+blue+str(s)+pink+']['+time+']['+blue+type_rect+pink+']['+blue+msg+pink+']['+blue+xu+pink+']','     ')
                                        if s==stop:break
                                        for a in range(delay,0,-1):
                                                print(quannumber,'['+blue+str(a)+pink+']','     ',end='\r')
                                                sleep(0.7)
                        except:
                                print(quannumber+pink+'['+red+'INTERNET KHÔNG ỔN ĐỊNH !!!'+pink+']','               ',end='\r')
                if s==stop:break
                if 'Trước tiên, bạn phải đăng nhập.' in check:
                                        print(quannumber+pink+'['+red+'COOKIE FACEBOOK DIE'+pink+']','                    ')
                                        break
        print(quannumber+pink+'[DỪNG TOOL ẤN'+blue+' ENTER !!!'+pink+']')
        ttacc=requests.get('https://traodoisub.com/api/?fields=profile&access_token='+str(token_tds)).json()
        if s==stop:print(quannumber+pink+'[CHẠY TOOL SUCCESS, TỔNG XU:',yellow+str(ttacc['data']['xu'])+']')